...
<div class="container-fluid">
	<div class="survey-info">
		<div class="item">
			<h2>今日注册用户</h2>
			<p class="num"><?php  echo $today_reg_num; ?></p>
			<p>日同比 0%</p>
			<p>总用户数 <?php  echo $reg_num; ?></p>
		</div>

		<div class="item">
			<h2>今日登录用户</h2>
			<p class="num"><?php echo $today_login_num; ?></p>
			<p>日同比 0%</p>
			<!--<p>总用户数 1000</p>-->
		</div>
		...
		<div class="item">
			<h2>今日上传文件数</h2>
			<p class="num"><?php echo $today_upload_num; ?></p>
			<p>日同比 0%</p>
			<p>总文件数 <?php echo $upload_num; ?></p>
		</div>

		<div class="item">
			<h2>今日总下载数</h2>
			<p class="num"><?php echo $today_down_num; ?></p>
			<p>日同比 0%</p>
			<p>总下载数 <?php echo $down_num; ?></p>
		</div>
	</div>
