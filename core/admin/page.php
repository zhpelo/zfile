...
<div class="container-fluid">
    <div class="block">
        <div class="block-header d-flex justify-content-between">
            <h3>单页管理</h3>
            <a href="?a=page&c=add"  class="btn btn-primary">新建</a>
        </div>
                    ...
                    <tbody>
                        <?php foreach ($data as &$item) {  ?>
                            <tr>
                                ...
                                <td>
                                    <a href="?a=page&c=delete&page_id=<?php echo $item['page_id']; ?>">删除</a>
                                    <a href="?a=page&c=edit&page_id=<?php echo $item['page_id']; ?>">编辑</a>
                                </td>
                            </tr>
                        <?php }  ?>
                    </tbody>
