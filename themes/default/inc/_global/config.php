...
require TEMPLATE . '/inc/_classes/Template.php';
...
$dm                             = new Template('裂变时代', '3.2', '/themes/default/assets');
...
$dm->main_nav_active            = $_SERVER['REQUEST_URI'];
